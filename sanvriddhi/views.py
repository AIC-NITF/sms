...
def sanvriddhi_excel(request):
    responce = HttpResponse(content_type='application/ms-excel')
    responce['content-Disposition'] = 'attachment; filename=Sanvriddhi' + str(datetime.datetime.now()) + '.xls'
    wb = xlwt.Workbook(encoding='utf-8')
    ws = wb.add_sheet('Sanvriddhi')
    row_num = 0
